...
function(a, b, c, d, e) {
	var f = "mui-control-item",
		...
		k = "mui-tab-item",
		l = function(a, b) {
			// return b.classList && (b.classList.contains(f) || b.classList.contains(k)) ? (b.parentNode && b.parentNode.classList && b.parentNode.classList.contains(h) || a.stopPropagation()(), b) : !1
		};
	a.registerTarget({
		name: d,
		index: 80,
